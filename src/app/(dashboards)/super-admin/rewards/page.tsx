...
export default function RewardsPage() {
  ...
  const { data: dashRes } = useGetSuperAdminDashboardQuery();
  ...
  const dashOverview = dashRes?.data?.overview || {};
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <StatCard
          ...
          count={dashOverview.totalRecognitions ? `${(dashOverview.totalRecognitions * 100).toLocaleString()}` : "0"}
