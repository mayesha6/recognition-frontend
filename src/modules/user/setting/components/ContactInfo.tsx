...
export default function ContactInfo({ user }: any) {
    ...
    const divStyle = "flex border border-gray-200 bg-gray-50/50 rounded-lg px-3 py-2 justify-between items-center w-full";
            ...
            <div className="flex flex-col gap-4">
                ...
                <div>
                    ...
                    <div className={divStyle}>
                        <input disabled {...register("email")} className="w-full bg-transparent text-gray-500 cursor-not-allowed outline-none" />
                ...
                <div className="grid gap-4 grid-cols-2">
                    <div className="w-full relative">
                        ...
                        <div className={divStyle}>
                            <input disabled className="w-full bg-transparent text-gray-500 cursor-not-allowed outline-none pr-2" value={user?.department || "N/A"} />
                    ...
                    <div className="w-full relative">
                        ...
                        <div className={divStyle}>
                            <input disabled className="w-full bg-transparent text-gray-500 cursor-not-allowed outline-none pr-2" value={user?.organization || "N/A"} />
                            <Lock className="text-gray-400 shrink-0" size={16} />
                        </div>
                    </div>
                </div>
