...
export default function AddRewardModal({ isOpen, onClose, onSave, isLoading }: any) {
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-[2px] flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl w-full max-w-lg p-6 shadow-xl border border-gray-100">
                <div className="flex justify-between items-center mb-6">
                    <h3 className="text-xl font-medium text-gray-900">Add New Reward</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button disabled={isLoading} type="submit" className="w-full mt-4 bg-gradient hover:bg-indigo-700 py-6 text-white text-base">
